...
Use the Markdown files in `D:\포트폴리오_최우석\Notion` as the import source.

Public Notion link:

```text
https://app.notion.com/p/0421d1336f4f4636b66fabd898b1761c?source=copy_link
```

## PPT/PDF Link Page

Keep the PPT/PDF short and connect to:
